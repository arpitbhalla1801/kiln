...
| 5 | DX/ecosystem surface — scaffolding generator (done), reference "hello world" doc (done, see [docs/writing-a-plugin.md](writing-a-plugin.md)), `kiln plugins list`/`verify` | #113 ✅, #114 ✅, #115 | in progress |
...
Docs-only phase, no runtime code. Full write-up lives in
[packages/sdk/README.md](../packages/sdk/README.md); summary:
