...
| 5 | DX/ecosystem surface — scaffolding generator (done), reference "hello world" doc (done, see [docs/writing-a-plugin.md](writing-a-plugin.md)), `kiln plugins list`/`verify` (done) | #113 ✅, #114 ✅, #115 ✅ | done |
